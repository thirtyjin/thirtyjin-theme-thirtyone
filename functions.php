...
if (! function_exists ( 'thirtyone_js_css_includes' )) {
	function thirtyone_js_css_includes() {
		...
		wp_register_script ( 'less_js', '//cdnjs.cloudflare.com/ajax/libs/less.js/1.7.1/less.min.js', false , '1.7.1', false );
	...
	function thirtyone_posted_on() {
		printf ( __ ( '
	 		<span class="post-date">
		 		<a class="icon icon-date" href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a>
	 		</span>
	 		<span class="by-author">
	 			<a class="author vcard icon icon-time" href="%5$s" title="%6$s" rel="author">%7$s</a>
	 		</span>
	 		', 'thirtyone' ), 
...
function nav_search_bar () {
	$thirtyone_header_search = ot_get_option('thirtyone_header_search',array());
	if ($thirtyone_header_search=='on' && !is_search() ){ get_search_form(); }
}
add_action('nav_search', 'nav_search_bar');
