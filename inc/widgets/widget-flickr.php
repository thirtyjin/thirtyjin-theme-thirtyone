...
/*-----------------------------------------------------------------------------------
	...
	Name: Custom Flickr Photostream
...
// Widget class
class thirty_one_flickr_widget extends WP_Widget {
...
function thirty_one_flickr_widget() {

	// Widget settings
	$widget_ops = array(
		'classname' => 'Thirty_One_Flickr_Widget',
		'description' => __('Displays your Flickr photos.', 'thirtyone')
	);
	...
	/*$control_ops = array(
		'width' => 300,
		'height' => 350,
		'id_base' => 'thirty_one_flickr_widget'
	);*/

	// Create the widget
	$this->WP_Widget( 'thirty_one_flickr_widget', __('Thirtyone Flickr Photos', 'thirtyone'), $widget_ops, $control_ops );
...
function form( $instance ) {
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'thirtyone') ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
	</p>

	<!-- Flickr ID: Text Input -->
	<p>
		<label for="<?php echo $this->get_field_id( 'flickrID' ); ?>"><?php _e('Flickr ID:', 'thirtyone') ?> (<a href="http://idgettr.com/">idGettr</a>)</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'postcount' ); ?>"><?php _e('Number of Photos:', 'thirtyone') ?></label>
	...
	<!-- Type: Select Box -->
	<p>
		<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php _e('Type (user or group):', 'thirtyone') ?></label>
	...
	<!-- Display: Select Box -->
	<p>
		<label for="<?php echo $this->get_field_id( 'display' ); ?>"><?php _e('Display (random or latest):', 'thirtyone') ?></label>
