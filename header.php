		...
		<div id="branding" role="banner" class="clearfix">		
			...
			<hgroup>
    			...
    			<div id="site-logo" style="background: none;">
    				<a id="site-title" class="icon icon-home" href="<?php echo home_url(); ?>"><?php bloginfo( 'name' ); ?></a>
	...
	<div id="main-navigation-content" class="w-container container_12">
		<nav id="access" role="navigation" class="grid_9">
				<div id="site-logo-name">
	    			<a href="<?php echo home_url(); ?>" class="icon icon-logo animated slideInRight" title="<?php bloginfo( 'name' ); ?>"><?php bloginfo( 'name' ); ?></a>
	    		</div>
			<?php wp_nav_menu( 
							array( 
